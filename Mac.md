...
33.   网易云音乐，下载 3.0 版本以上的，解决了内存泄漏问题
...
55.   Trace，可以记录开启后各个应用的使用时长，没怎么用过，ui 做的还挺好看

56.   Deskreen，有局域网的情况下，可以几乎无延迟共享屏幕到任何设备上（只要有浏览器）

57.   Textsnipper，精度较高的 OCR 识别软件，[cracked]

58.   Popclip，提供了一些鼠标划词后的操作，比如翻译之类的

59.   Command X，没错，Mac 不支持剪切文件这个操作，不过下载这个软件之后就可以了

60.   爱思助手，从手机上拷贝照片什么的

61.   AltTab，减少从 Windows 过来的不适应，苹果会把一个应用的多个窗口合并成一个窗口，有点不方便
      ...
      1.   控制
           ...
           3.   窗口选择方式：框选“鼠标悬停”
      2.   外观
           1.   ![image-20240922235435443](https://gitee.com/sekiro_meng/images/raw/master/mac-air/2024/2024-09-22/2024-09-22T23:54:36.png)

62.   飞书

63.   Mos，最基础的功能是反转鼠标滚动方向，还可以调节灵敏度等功能，[cracked]
